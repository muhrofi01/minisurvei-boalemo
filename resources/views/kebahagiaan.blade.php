        ...
        <div class="mt-10">
            ...
            <form action="{{ route('kebahagiaan.store') }}" method="POST" class="mt-10">
                ...
                <div class="mt-6 flex justify-between">
                    ...
                    <button type="submit" class="text-white bg-[#f79039] hover:bg-[#f79039]/80 focus:ring-4  font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-[#f79039] dark:hover:bg-[#f79039] focus:outline-none ">Hitung</button>
                </div>
            </form>
        </div>
    </div>
